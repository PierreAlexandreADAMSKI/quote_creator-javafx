...
public class RowAdapter {
	...
	public void setPriceGen(Number priceGen) {priceGenProperty().set(priceGen);}
	public void setPriceWrite(Number priceWrite) {priceWriteProperty().set(priceWrite);}
	public void setProduct(String product) {productProperty().set(product);}
	public void setSel(boolean sel) {selProperty().set(sel);}
	public void setSeller(String seller) {sellerProperty().set(seller);}
	public void setSizeSquare(Number sizeSquare) {sizeSquareProperty().set(sizeSquare);}
	public void setTva(Number tva) {tvaProperty().set(tva);}
	public Number getPriceGen() {return priceGenProperty().get();}
	public Number getPriceWrite() {return priceWriteProperty().get();}
	public String getProduct() {return productProperty().get();}
	public boolean getSel() {return selProperty().get();}
	public String getSeller() {return sellerProperty().get();}
	public Number getSizeSquare() {return sizeSquareProperty().get();}
	public Number getTva() {return tvaProperty().get();}
