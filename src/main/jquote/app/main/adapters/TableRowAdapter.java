...
public class TableRowAdapter {
	...
	public TableRowAdapter(String name, String product, String seller, Float size, String unit, Float tva, Float priceWrite) {
		setName(name);
		setProduct(product);
		setSeller(seller);
		setSize(size);
	...
	public TableRowAdapter(JsonRowAdapter jsonRowAdapter) {
